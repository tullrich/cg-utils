...
cgutils: $(_OBJECTS)
	$(CXX) -std=c++11 $(_OBJECTS) -o $(BUILD_DIR)$(PROGRAM_NAME) 

cgutils-test: $(_TEST_OBJECTS) $(_SOURCE_SANS_MAIN)
	$(CXX) -std=c++11 $(_TEST_OBJECTS) $(_SOURCE_SANS_MAIN) -o $(BUILD_DIR)$(TEST_PROGRAM_NAME) -lpthread -lgtest_main -lgtest
